...
const counterUp = window.counterUp.default
        ...
        let el = document.querySelector('.counter1')
        let al = document.querySelector('.counter2')
        let sl = document.querySelector('.counter3')
        let dl = document.querySelector('.counter4')
        let tl = document.querySelector('.counter5')
        IO.observe(el)
        IO.observe(al)
        IO.observe(sl)
        IO.observe(dl)
